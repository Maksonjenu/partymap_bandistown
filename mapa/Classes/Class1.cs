...
namespace mapa.Classes
{
    class Class1 : MapObject
    {
        ...
        public Class1 (PointLatLng point, string name) : base (name)
        {
    ...
    namespace CodeBeautify
    {
        ...
        public partial class Artists
        {
            public static Artists[] FromJson(string json) => JsonConvert.DeserializeObject<Artists[]>(json, CodeBeautify.Converter.Settings);
        ...
        {
            public static string ToJson(this Artists[] self) => JsonConvert.SerializeObject(self, CodeBeautify.Converter.Settings);
        }
